...
const CoinList = () => {
    ...
    //Sin funcionamiento, debido a que los navegadores no permiten peticiones no seguras.
    ...
    const getCoins = async (texto) => {
        const response = await fetch("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=100&page=1&sparkline=false"); //Respuesta de la API
